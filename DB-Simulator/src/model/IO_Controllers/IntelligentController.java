...
public class IntelligentController extends IO_Controller_Abstract{
    private Long cache;

    public IntelligentController(Long reactionTimeRead, Long getReactionTimeWrite, Long cache) {
        this.cache = cache;
    }
